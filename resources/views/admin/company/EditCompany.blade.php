...
@section('content')
    <div class="container">
        <div id="default">
            <div class="card mb-4">
                <div class="card-header cursor-hover">Edit Company</div>
                <div class="card-body cursor-hover">
                    <div class="sbp-preview cursor-hover">
                        <div class="sbp-preview-content cursor-hover">
                            <form action="{{ route('updateCompany', $company->id_company) }}" method="post"
                                class="cursor-hover">
                                @csrf
                                <div class="container-inputDialog" id="dialogs-container">
                                    ...
                                    <div class="mb-3 cursor-hover">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlInput1" name="about_us"
                                            placeholder="Please Input Chpater Stories...." required >{{ $company->about_us }}</textarea>
                                    </div>
                                    <div class="mb-3 cursor-hover">
                                        <label for="term" class="cursor-hover">Term</label>
                                        <textarea class="form-control" id="exampleFormControlInput1" name="term"
                                            placeholder="Please Input Chpater Stories...." required >{{ $company->term }}</textarea>
                                    </div>
                                    <div class="mb-3 cursor-hover">
                                        <label for="privacy" class="cursor-hover">Privacy</label>
                                        <textarea class="form-control" id="exampleFormControlInput1" name="privacy"
                                            placeholder="Please Input Chpater Stories...." required >{{ $company->privacy }}</textarea>
                                    </div>
                                </div>
